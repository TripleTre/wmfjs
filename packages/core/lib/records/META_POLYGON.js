...
exports.META_POLYGON = void 0;
const Serializable_1 = require("../Serializable");
const decorators_1 = require("../decorators");
const enums_1 = require("../enums");
const PointS_1 = require("../structs/PointS");
class META_POLYGON extends Serializable_1.SerializableRecord {
    constructor() {
        super(...arguments);
        this.recordFunction = enums_1.RecordType.META_POLYGON;
        this.aPoints = [];
    }
    get recordSize() {
        return (4 + 2 + 2 + (this.numberOfPoints * 4)) / Serializable_1.BYTE_PER_WORD;
    }
    ;
    get numberOfPoints() {
    ...
    set numberOfPoints(v) {
        if (this.aPoints.length === 0) {
            for (let i = 0; i < v; i++) {
                this.aPoints.push(new PointS_1.PointS());
            }
        }
    }
}
...
__decorate([
    (0, decorators_1.serialize)({ collection: Array, element: PointS_1.PointS }),
    __metadata("design:type", Array)
], META_POLYGON.prototype, "aPoints", void 0);
exports.META_POLYGON = META_POLYGON;
