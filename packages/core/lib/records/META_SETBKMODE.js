...
exports.META_SETBKMODE = void 0;
const Serializable_1 = require("../Serializable");
const decorators_1 = require("../decorators");
const enums_1 = require("../enums");
class META_SETBKMODE extends Serializable_1.SerializableRecord {
    constructor() {
        super(...arguments);
        this.recordFunction = enums_1.RecordType.META_SETBKMODE;
        this.BkMode = enums_1.MixMode.TRANSPARENT;
...
], META_SETBKMODE.prototype, "recordSize", null);
__decorate([
...
exports.META_SETBKMODE = META_SETBKMODE;
